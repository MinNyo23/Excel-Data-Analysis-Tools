...
export default function Home() {
  ...
  return (
    <main className={`app-shell tool-app-shell tool-${activeTool}`}>
      ...
      {isAuthenticated ? <section className="container"><WhatsNewBanner /></section> : null}
      ...
      <section className="container work-area tool-section tool-consolidation">
        <Card className="upload-card">
          ...
          <CardContent>
            ...
            <WorkflowProgress active={isBusy} />
          </CardContent>
        </Card>
